          ...
          {item.Expense == "Travel" &&
            <div className="form-group col-md-1">
              ...
              <input
                ...
                type="number"
                min="1"
                disabled={item.TravelType == "Leased/Self Owned" || !this.state.IExpenseModel[idx].StartMile||this.state.SelectedTabType == "MyTask" || item.TravelType == "Cab/Uber/Lyft" || item.TravelType == "Airfare" || this.state.selectedExpense.formType == "View" ? true : false}
                className={contentEditFormStyles.formControl}
                name="EndMileout"
