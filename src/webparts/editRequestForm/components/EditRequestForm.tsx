      ...
      return (<span key={idx}>
        ...
        <div className={this.props.tabType != "MyTask" && this.props.selectedItem.formType == "Edit" ? styles.formRow : styles.editRequestTable}>
          <div className="form-group col-md-2">
            ...
            <select 
            disabled={IsExpenseTypeDisable || this.props.selectedItem.formType == "View" || this.props.tabType == "MyTask"} 
            className='form-control ExpTypeSelectOptions' 
            name="Expense" 
            defaultValue={this.state.IExpenseModel[idx].Expense} 
            value={this.state.IExpenseModel[idx].Expense} 
          ...
          {item.Expense == "Travel" &&
            <div className="form-group col-md-2">
              ...
              <select disabled={this.props.tabType == "MyTask" || this.props.selectedItem.formType == "View" ? true : false} 
              className='form-control ExpTypeSelectOptions' 
              name="TravelType" 
              defaultValue={this.state.IExpenseModel[idx].TravelType} 
              value={this.state.IExpenseModel[idx].TravelType} 
              id={this.state.IExpenseModel[idx].id} 
              onChange={this.handleChange(idx)}>
              <option value="">Select</option>
          ...
          {item.Expense == "Travel" &&
            <div className="form-group col-md-2">
              ...
              <input
                ...
                type="number"
                min="1"
                disabled={this.props.tabType == "MyTask" || item.TravelType == "Cab" || this.props.selectedItem.formType == "View"||item.TravelType == "Leased/Self Owned" || !this.state.IExpenseModel[idx].StartMile? true : false}
                className='form-control'
                name="EndMileout"
